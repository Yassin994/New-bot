...
adams({
  ...
  const _0x2f4eff = await fetch('https://api.github.com/repos/yassin994/YESSER-MD');
  ...
  if (_0x36b130) {
    ...
    const _0x20cf11 = "YESSER 𝐌𝐃 𝐆𝐈𝐓𝐇𝐔𝐁 𝐈𝐍𝐅𝐎𝐌𝐄𝐓𝐈𝐎𝐍.  \n𝐂𝐑𝐄𝐓𝐄𝐃 𝐁𝐘 YESSER TECH.\n\n𝐒𝐓𝐀𝐑⭐ 𝐓𝐇𝐄 𝐑𝐄𝐏𝐎 𝐓𝐇𝐄𝐍 𝐅𝐎𝐑𝐊🍴\n\n📂 Repository Name: *YESSER-MD*\n📝 Last Update: " + _0x50985d.lastUpdate + "\n👤 Owner: *yesser tech*\n⭐ Stars: " + _0x50985d.stars + "\n🍴 Forks: " + _0x50985d.forks + "\n🌐 Repo: " + _0x36b130.html_url + "\n⭕ For More Info : https://github.com/yassin994-INFO⁠\n";
...
adams({
  ...
  const _0x23b84a = await fetch("https://api.github.com/repos/yassin994/YESSER-MD");
...
adams({
  ...
  const _0x21464f = await fetch("https://api.github.com/repos/yassin994/YESSER-MD");
...
adams({
  ...
  const _0x10746e = await fetch("https://api.github.com/repos/yassin994/YESSER-MD");
